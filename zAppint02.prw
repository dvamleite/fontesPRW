...
// Sao 23 tipos de botoes, com imagens pré-definidas
	DEFINE SBUTTON osBtn01 FROM 250 , 05  TYPE 01 ACTION (MsgInfo("SButton 01= ok")) OF oDlg ENABLE
	DEFINE SBUTTON osBtn02 FROM 250 , 45  TYPE 02 ACTION (MsgInfo("SButton 02 = cancelar")) OF oDlg ENABLE
	DEFINE SBUTTON osBtn03 FROM 250 , 85  TYPE 03 ACTION (MsgInfo("SButton 03 = excluir")) OF oDlg ENABLE
